function credit_click(department){
    ...
    detail_credit.innerText = "一般科目 : " + String(ippan) + " 単位 / 専門科目 : " + String(senmon) + " 単位";
    required_credit.innerText = "必修科目 : " + String(required) + " 単位";
    
    if(167 - credit_count < 0){
        credit_countdown.innerText = "167 単位から " + String(credit_count - 167)  + "単位余分に取得";
    }else{
        credit_countdown.innerText = "167 単位まであと "  + String(167 - credit_count) + " 単位";
    }
}