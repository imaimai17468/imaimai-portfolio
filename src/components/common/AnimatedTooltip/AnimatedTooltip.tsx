...
export const AnimatedTooltip = ({ name, children }: AnimatedTooltipProps) => {
  ...
  return (
    <div className='group  relative -mr-4' onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)}>
      <AnimatePresence mode='wait'>
        {hovered && (
          ...
          >
            ...
            <div className='relative z-30 text-base font-bold text-white'>{name}</div>
          </motion.div>
        )}
      </AnimatePresence>
